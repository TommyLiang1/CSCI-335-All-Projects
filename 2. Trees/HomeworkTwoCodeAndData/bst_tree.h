// Author: Tommy Liang
// Date: 10/11/2021
// Main file the implementation of the Binary Search Tree
// Contains the methods to run all of part 2b
...
private:
     ...
     */
    BinaryNode *findMin(BinaryNode *t, int &counter) const
    {
        if (t == nullptr)
            return nullptr;
        if (t->left == nullptr)
...
*****************************************************/
    ...
    /**
     * Internal method to print a certain element's enzyme acronym
     */
    void printEnzAcro(const string &x, BinaryNode *t) const
    {
        if (t == nullptr)
            cout << "Not Found\n";
