// Code from textbook
// Modified by: Tommy Liang
// This is the file that contains all the sorting algorithms for Homework 4
...
// implementaton to find middle pivot
template <typename Comparable, typename Comparator>
...
// implementaiton to find first pivot
template <typename Comparable>
...
// quicksort2 implementation for middle pivot
template <typename Comparable, typename Comparator>
...
// quicksort implementation for first pivot
template <typename Comparable, typename Comparator>
void quicksort3(vector<Comparable> &a, int left, int right, Comparator less_than)
{
    if (left + 10 <= right)
    {
        ...
        // median3(a, left, right, less_than);
...
// @a: input/output vector to be sorted.
// @less_than: Comparator to be used.
// Quicksort driver with runtime function added
template <typename Comparable, typename Comparator>
void QuickSort(vector<Comparable> &a, Comparator less_than)
{
...
// another version of the median of 3 partitioning just to use without the cout of "Quicksort"
template <typename Comparable, typename Comparator>
void Median3(vector<Comparable> &a, Comparator less_than)
{
    quicksort(a, less_than);
}
